...
#define STDIN_FILENO    0x0200       /* standard input file descriptor */
#define STDOUT_FILENO   0x0201       /* standard output file descriptor */
#define STDERR_FILENO   0x0202       /* standard error file descriptor */
#else
