...
#define PTHREAD_ATTR_SET_CONTENTION_SCOPE(ptr, value) do { ptr->status &= ~0xFF000000; ptr->status |= ((value & 0xFF) << 24); } while(0)
#define PTHREAD_ATTR_SET_GUARDSIZE(ptr, value) do { ptr->status &= ~0x00FF0000; ptr->status |= ((value & 0xFF)  << 16); } while(0)
#define PTHREAD_ATTR_SET_INHERIT_SCHED(ptr, value) do { ptr->status &= ~0x0000F000; ptr->status |= ((value & 0xFF)  << 12); } while(0)
#define PTHREAD_ATTR_SET_SCHED_POLICY(ptr, value) do { ptr->status &= ~0x00000F00; ptr->status |= ((value & 0xFF)  << 8); } while(0)
#define PTHREAD_ATTR_SET_DETACH_STATE(ptr, value) do { ptr->status &= ~0x000000F0; ptr->status |= ((value & 0xF)  << 4); } while(0)
#define PTHREAD_ATTR_SET_IS_INITIALIZED(ptr, value) do { ptr->status &= ~0x0000000F; ptr->status |= (value & 0xF); } while(0)

#define PTHREAD_ATTR_GET_CONTENTION_SCOPE(ptr) ((ptr->status & 0xFF000000) >> 24)
#define PTHREAD_ATTR_GET_GUARDSIZE(ptr) ((ptr->status & 0x00FF0000) >> 16)
#define PTHREAD_ATTR_GET_INHERIT_SCHED(ptr) ((ptr->status & 0x0000F000) >> 12)
#define PTHREAD_ATTR_GET_SCHED_POLICY(ptr) ((ptr->status & 0x00000F00) >> 8)
#define PTHREAD_ATTR_GET_DETACH_STATE(ptr) ((ptr->status & 0x000000F0) >> 4)
#define PTHREAD_ATTR_GET_IS_INITIALIZED(ptr) ((ptr->status & 0x0000000F))
...
#define PTHREAD_MUTEX_FLAGS_RECURSIVE (1<<0)
#define PTHREAD_MUTEX_FLAGS_PSHARED (1<<1)
#define PTHREAD_MUTEX_FLAGS_INITIALIZED (1<<2)
